# The DeFi Risk Alliance Charter

Crypto emerged from the failures of 2008. A response to opacity, unchecked leverage, and systems built on trust rather than verified truth.

> Its founding promise was simple and radical:
> Finance should be transparent, permissionless, and accountable by design.
...
> When risk is invisible, failure becomes inevitable.
...
Opacity itself is a risk factor. When key data is missing, unverifiable, or offchain:
...
We are forming the **DeFi Risk Alliance**:

A working group of risk assessors, auditors, researchers, aggregators, wallets, and institutions building:
...
- Versioned histories showing how assessments evolve
